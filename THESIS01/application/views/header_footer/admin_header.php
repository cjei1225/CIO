...
<body class="grey lighten-4">
  ...
  <div class="container">
        <!-- Dropdown Structure -->
         <ul id="Create_drop" class="dropdown-content">            
                <li id="textzied"><a href="Create_Dorm">Create Dormitory</a></li>
                <li class="divider"></li> 
                <li id="textzied"><a href="register">Create User</a></li>
                <li class="divider"></li> 
                <li id="textzied"><a href="Admin_Conference_Create">Create Conference</a></li>
                <li class="divider"></li> 
                
         </ul>
         <ul id="Client_list" class="dropdown-content">            
                <li id="textzied"><a href="Admin_Pending_Clients">Pending Admissions</a></li>
                <li class="divider"></li> 
                <li id="textzied"><a href="admin_social_case">Custody</a></li>
                <li class="divider"></li> 
                <li id="textzied"><a href="Admin_Pending_Discharge">Pending Discharge</a></li>
                <li class="divider"></li> 
         </ul>
          ...
          <!-- Dropdown Others Structure -->
                ...
                <li class="divider"></li> 
                <li id="textzied"><a href="Admin_Reports">Reports</a></li>
                <li class="divider"></li> 
                <li id="textzied"><a href="Admin_Conference">Conferences</a></li>
                <li class="divider"></li>
          </ul>
      ...
      <nav class="light-green lighten-2">
        <div class="nav-wrapper">
          ...
          <ul class="left side-nav">
            ...
            <li id="navsize" class="center "><a href="#" class="dropdown-button" data-activates="Create_drop">Create<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
            <li id="navsize" class="center "><a href="#" class="dropdown-button" data-activates="Client_list">Clients<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
