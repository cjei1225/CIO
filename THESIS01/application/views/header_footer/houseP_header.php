      ...
      <nav class="light-green lighten-2">
        <div class="nav-wrapper">
          ...
          <ul class="left side-nav">
            ...
            <li id="navsize" class="center "><a href="house_house_plans">House Plans</a></li>
            <li id="navsize" class="center "><a href="house_reports">Daily Reports</a></li>
            <li id="navsize" class="center "><a href="get_conferences">Conferences</a></li>
          </ul>
