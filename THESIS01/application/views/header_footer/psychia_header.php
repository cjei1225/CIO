      ...
      <nav class="light-green lighten-2">
        <div class="nav-wrapper">
          ...
          <ul class="left side-nav">
            ...
            <li id="navsize" class="center "><a href="psychia_medical">Medical Files<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
             <li id="navsize" class="center "><a href="get_request">Requests<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
            <li id="navsize" class="center "><a href="get_conferences">Conferences<i class="mdi-navigation-arrow-drop-down right"></i></a></li>
          </ul>
