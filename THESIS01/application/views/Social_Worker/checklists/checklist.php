...
<main >
    <div class="container">
    	<div class="row">
        <?php include($_SERVER['DOCUMENT_ROOT'].'/Thesis_programs/Current/THESIS01/application/views/header_footer/sidebar_checklist.php'); ?>
	     	<div class="col s10">
	     		<div class="col s4">
		        	<?php
		    ...
		    <div class="col s10">
                  ...
                  <?php 
                          ...
                          if($client_sector == 1){include($_SERVER['DOCUMENT_ROOT'].'/Thesis_programs/Current/THESIS01/application/views/Social_Worker/checklists/check_list_CY.php'); }
                          elseif($client_sector == 2){include($_SERVER['DOCUMENT_ROOT'].'/Thesis_programs/Current/THESIS01/application/views/Social_Worker/checklists/check_list_OP.php');}
                          elseif($client_sector == 3){include($_SERVER['DOCUMENT_ROOT'].'/Thesis_programs/Current/THESIS01/application/views/Social_Worker/checklists/check_list_SP.php'); }
                          elseif($client_sector == 4){include($_SERVER['DOCUMENT_ROOT'].'/Thesis_programs/Current/THESIS01/application/views/Social_Worker/checklists/check_list_CS.php'); }  
        ?>
		        </fieldset>
		    </div>
		</div>
