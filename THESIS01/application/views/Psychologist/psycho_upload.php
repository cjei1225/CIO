...
<main>
    <div class="container">
        <fieldset class="z-depth-2">
               <center>
                    <h5 class="bold">Psychological files</h5>
                  </center>
                    ...
                    <div class="form-group">
                      ...
                      <label >Dorm: <?php echo $dorm_id; ?></label>
                          <br>                       
                            ...
                            <?php echo form_open_multipart('auth/psycho_upload'); ?>
                            ...
                            <div class="col s7">
                                <?php echo form_open('auth/before_psych_rep'); 
                                echo form_hidden('client_id', $client_id);
                                ?>
                           

                                <button class="btn  waves-effect btn-md  blue" type="submit" name="action">Create Psychological Report</button>
                                <?php echo form_close(); ?>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo date('F d Y', strtotime($files_row->created)); ?></td>
                                            <td>
                                            <?php 
                                           ...
                                           <button class="btn  waves-effect btn-md  blue z-depth-2" type="submit" name="action">Download</button>
                                        </td>
                                        </tr>
                                        <?php echo form_close(); ?>
                                       <?php } ?>
